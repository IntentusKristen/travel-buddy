 ...
 */
declare class MapboxOverlayFactory implements OverlayFactory {
    /**
     ...
     * @memberof OverlayFactory
     */
    polygon(layer: string, shapes: PolygonDef[], style: ShapeStyle): Mapbox.Polygon;
    polyline(layer: string, points: Coordinate[], style: ShapeStyle): Mapbox.Polyline;
}
export default MapboxOverlayFactory;
